...
class SampleTableViewController: UIViewController {
    ...
    private func setDateInformations(){
        ...
        let date3 = DateInformation(weather: .snowy, date: "3월 1일", subTitle: "삼일절")
        let date4 = DateInformation(weather: .sunny, date: "5월 1일", subTitle: "어린이날")
